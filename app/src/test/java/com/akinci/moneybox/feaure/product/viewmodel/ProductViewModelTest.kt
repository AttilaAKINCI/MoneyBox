...
import com.akinci.moneybox.common.component.filedownloader.FakeFileDownloader
import com.akinci.moneybox.common.storage.FakeLocalPreferences
import com.akinci.moneybox.common.storage.PrefConfig
import com.akinci.moneybox.feaure.product.detail.repository.FakePaymentRepository
import com.akinci.moneybox.feaure.product.list.repository.FakeProductListRepository
...
class ProductViewModelTest {
    ...
    fun `test fetch username from local preferences return error if provided`(){
        ...
        fakeLocalPreferences.setStoredTag(PrefConfig.USERNAME, userName)
